...
function setup() {
  ...
  //level one
  blocks1 = new Block(660,175,30,40);
  blocks2 = new Block(690,175,30,40);
  blocks3 = new Block(720,175,30,40);
  blocks4 = new Block(750,175,30,40);
  blocks5 = new Block(780,175,30,40);
  //level two
  blocks6 = new Block(690,135,30,40);
  blocks7 = new Block(720,135,30,40);
  blocks8 = new Block(750,135,30,40);
  //top
  blocks9 = new Block(720,95,30,40);
